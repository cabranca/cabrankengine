...
namespace cbk::platform::vk {
	...
	void VulkanTexture2DMaterial::initSharedResourcesIfNeeded() {
		...
		std::array<VkVertexInputAttributeDescription, 5> vertexAttributes = {
			VkVertexInputAttributeDescription{ .location = 0, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT,    .offset = offsetof(Renderer2DVertex, position)     },
			VkVertexInputAttributeDescription{ .location = 1, .binding = 0, .format = VK_FORMAT_R32G32B32A32_SFLOAT, .offset = offsetof(Renderer2DVertex, color)        },
			VkVertexInputAttributeDescription{ .location = 2, .binding = 0, .format = VK_FORMAT_R32G32_SFLOAT,       .offset = offsetof(Renderer2DVertex, texCoord)     },
			VkVertexInputAttributeDescription{ .location = 3, .binding = 0, .format = VK_FORMAT_R32_SFLOAT,          .offset = offsetof(Renderer2DVertex, texIndex)     },
			VkVertexInputAttributeDescription{ .location = 4, .binding = 0, .format = VK_FORMAT_R32_SFLOAT,          .offset = offsetof(Renderer2DVertex, tilingFactor) },
		};
