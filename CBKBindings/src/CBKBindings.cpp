...
static void setGameMode() {
	rendering::RenderLayer::setEditorMode(false);
}
static void setEditorMode() {
	rendering::RenderLayer::setEditorMode(true);
}
...
static std::string getTransform(int e) {
	return getComponent<ecs::CTransform>(e);
}
static std::string getCamera(int e) {
	return getComponent<ecs::CCamera>(e);
}
static std::string getCameraController(int e) {
	return getComponent<ecs::CCameraController>(e);
}
static std::string getDirectionalLight(int e) {
	return getComponent<ecs::CDirectionalLight>(e);
}
static std::string getPointLight(int e) {
	return getComponent<ecs::CPointLight>(e);
}
static std::string getText(int e) {
	return getComponent<ecs::CText>(e);
}
...
static void addTransform(int e, const std::string& json) {
	addComponent<ecs::CTransform>(e, json);
}
static void addCamera(int e, const std::string& json) {
	addComponent<ecs::CCamera>(e, json);
}
static void addCameraController(int e, const std::string& json) {
	addComponent<ecs::CCameraController>(e, json);
}
static void addDirectionalLight(int e, const std::string& json) {
	addComponent<ecs::CDirectionalLight>(e, json);
}
static void addPointLight(int e, const std::string& json) {
	addComponent<ecs::CPointLight>(e, json);
}
static void addText(int e, const std::string& json) {
	addComponent<ecs::CText>(e, json);
}
static void addModel(int e, const std::string& json) {
	addComponent<ecs::CModel>(e, json);
}
...
static void setTransform(int e, const std::string& json) {
	setComponent<ecs::CTransform>(e, json);
}
static void setCamera(int e, const std::string& json) {
	setComponent<ecs::CCamera>(e, json);
}
static void setCameraController(int e, const std::string& json) {
	setComponent<ecs::CCameraController>(e, json);
}
static void setDirectionalLight(int e, const std::string& json) {
	setComponent<ecs::CDirectionalLight>(e, json);
}
static void setPointLight(int e, const std::string& json) {
	setComponent<ecs::CPointLight>(e, json);
}
static void setText(int e, const std::string& json) {
	setComponent<ecs::CText>(e, json);
}
...
static void removeTransform(int e) {
	removeComponent<ecs::CTransform>(e);
}
static void removeCamera(int e) {
	removeComponent<ecs::CCamera>(e);
}
static void removeCameraController(int e) {
	removeComponent<ecs::CCameraController>(e);
}
static void removeDirectionalLight(int e) {
	removeComponent<ecs::CDirectionalLight>(e);
}
static void removePointLight(int e) {
	removeComponent<ecs::CPointLight>(e);
}
static void removeText(int e) {
	removeComponent<ecs::CText>(e);
}
